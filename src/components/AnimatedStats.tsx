    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center w-full">
            ...
            >
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Find the perfect hotel within reasonable distance of your venue.</p>
            </motion.div>
...
export function TechnologiesGrid() {
    return (
        <motion.div
            ...
            className="w-full"
        >
            <p className="text-gray-500 dark:text-gray-400 text-base md:text-sm mb-8 text-center">Powering your experience</p>
            <div className="flex flex-wrap items-center justify-center gap-10 lg:gap-8 opacity-80 hover:opacity-100 transition-opacity">
                {/* Vercel */}
